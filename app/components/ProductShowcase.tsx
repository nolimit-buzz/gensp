  ...
  return (
    <section id="how-it-works" className="py-24 bg-[#020014]">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
          {/* Main Left Sidebar */}
          <div className="flex flex-row lg:flex-col gap-2 md:gap-5 w-full lg:w-[320px] min-w-0 lg:overflow-x-visible pb-2 lg:pb-0 scrollbar-hide">
            {mainTabs.map((tab) => {
          ...
          <div className="flex-1 w-full bg-[#414946] rounded-[30px] md:rounded-[48px] p-0 lg:p-12 border-0 md:border md:border-white/10 shadow-2xl overflow-hidden">
            ...
            <div className="bg-[#131314] lg:rounded-[32px] px-4 lg:px-8 pt-4 lg:pt-8 flex flex-col lg:flex-row gap-8 items-stretch min-h-[700px]">
              {/* Inner Sidebar Tabs */}
              ...
              <div className="flex-1 flex flex-col gap-4">
                ...
                <div className="bg-[#151719] rounded-t-[24px] overflow-hidden flex flex-col h-[800px]">
                  ...
                  <div className="border-b border-white/5 flex items-stretch h-14">
                    {/* Logo Section */}
                    <div className="px-4 lg:px-6 flex items-center justify-center border-r border-white/5">
                    ...
                    {/* Helpful Section */}
                    <div className="flex items-center px-4 lg:px-6 gap-6">
                  ...
                  <div className="flex-1 overflow-y-auto px-0 lg:px-8 py-4 custom-scrollbar">
