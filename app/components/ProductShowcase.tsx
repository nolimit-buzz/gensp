    ...
    <section id="how-it-works" className="py-24 bg-[#020014]">
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        >
            ...
            {mainTabs.map((tab) => {
              ...
              return (
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className={`flex flex-col justify-center gap-3 px-10 h-[120px] rounded-[20px]  transition-all duration-300 text-left ${isActive
                    ? 'bg-[#3A4943] shadow-xl'
          ...
          <div className="flex-1 w-full bg-[#1A1C1E] rounded-[48px] p-12 border border-white/10 shadow-2xl overflow-hidden">
            ...
            <div className="bg-[#0A0C10] rounded-[32px] px-8 pt-8 flex flex-col lg:flex-row gap-8 items-stretch min-h-[700px]">
              {/* Inner Sidebar Tabs */}
              ...
              <div className="flex-1 flex flex-col gap-4">
                ...
                {/* Document Card */}
                <div className="bg-[#151719] rounded-t-[24px] overflow-hidden flex flex-col h-[800px]">
                  {/* Header */}
                  <div className="border-b border-white/5 flex items-stretch h-14">
                    {/* Logo Section */}
                    <div className="px-6 flex items-center justify-center border-r border-white/5">
                    ...
                    {/* GenSP Section */}
                    <div className="flex-1 flex items-center px-6 border-r border-white/5">
                      <span className="text-white font-bold text-[13px] tracking-tight">GenSP</span>
                    </div>

                    {/* Helpful Section */}
                    <div className="flex items-center px-6 gap-6">
                      <span className="text-[9px] text-[#71D5CB] font-bold tracking-widest">Was this helpful</span>
                      <div className="flex gap-4">
                        <ThumbsUp className="w-3.5 h-3.5 text-white/40 cursor-pointer hover:text-white transition-colors" />
                        <ThumbsDown className="w-3.5 h-3.5 text-white/40 cursor-pointer hover:text-white transition-colors" />
                      </div>
                    </div>
                  </div>
