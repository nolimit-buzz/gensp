      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="flex flex-col">
          ...
          >
            {pillars.map((p, idx) => (
              ...
              >
                ...
                <p className={`text-[11px] leading-relaxed ${activeTab === idx ? 'text-white/80' : 'text-gray-500'}`}>
                  {p.desc}
                </p>
              </button>
            ))}
          ...
          >
            ...
            {/* Chat Area */}
            <div className="flex-1 bg-black p-8 space-y-8 flex flex-col justify-start">
              {/* Coach Message */}
              ...
              <div className="flex flex-col items-end gap-3 pt-4">
                <div className="bg-[#1A1D1F] border border-[#71D5CB]/40 p-6 rounded-[24px] rounded-tr-none max-w-[560px] shadow-lg shadow-[#71D5CB]/5">
                  <p className="text-[12px] text-white/90 leading-relaxed font-normal">
                ...
                {activeTab === 3 && (
                  <div className="bg-[#1A1D1F] border border-[#71D5CB]/40 p-4 rounded-[16px] rounded-tr-none flex items-center gap-3 w-fit pr-12 shadow-lg shadow-[#71D5CB]/5">
                    <div className="w-8 h-8 rounded-lg bg-white/5 flex items-center justify-center border border-white/10">
                      <FileText size={16} className="text-white/40" />
                    </div>
                    <span className="text-[12px] text-white/90 font-medium tracking-tight">ROI_model.pptx</span>
                  </div>
                )}
              </div>
